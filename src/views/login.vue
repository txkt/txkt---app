<template>
	<div id="login">
		...
		<ul class="l_ul">
			...
			<div id="l_ul_done" v-show="l_ul_doneShow" @click="deletes('linputCon')"></div>
			<div id="l_ul_dtwo" v-show="l_ul_dtwoShow" @click="deletes('linputContent')"></div>
		</ul>
	</div>
</template>
...
<style>
	...
	#l_ul_dtwo{
		height: .44rem;
		width: 8%;
		background: url(../assets/dyw-img/android_logo_v1.png) no-repeat center;
